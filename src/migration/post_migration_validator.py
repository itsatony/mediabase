...
class PostMigrationValidator:
    ...
    def __init__(self, db_manager: DatabaseManager, config: Dict[str, Any]):
        ...
        self.thresholds = {
            ...
            "performance_improvement_factor": config.get(
                "performance_improvement_threshold", 2.0
            ),
    ...
    def _validate_data_integrity(self) -> List[ValidationResult]:
        ...
        duplicate_checks = [
            ...
            (
                ...
                "SELECT COUNT(*) - COUNT(DISTINCT transcript_id) FROM transcripts",
            ),
            (
                "Drug Duplicates",
                "SELECT COUNT(*) - COUNT(DISTINCT drug_interaction_id) FROM drug_interactions",
            ),
        ]
    ...
    def _validate_data_accuracy(self) -> List[ValidationResult]:
        ...
        results.append(
            ValidationResult(
                ...
                status="pass"
                if comparison.accuracy_percent
                >= self.thresholds["data_accuracy_percent"]
                else "fail",
        ...
        results.append(
            ValidationResult(
                ...
                status="pass"
                if drug_comparison.accuracy_percent
                >= self.thresholds["data_accuracy_percent"]
                else "fail",
        ...
        for test_name, old_query, new_query in performance_tests:
            ...
            results.append(
                ValidationResult(
                    ...
                    >= self.thresholds["performance_improvement_factor"]
                    else "warning",
    ...
    def _validate_index_effectiveness(self) -> List[ValidationResult]:
        ...
        index_tests = [
            ...
            (
                "Transcript Index",
                "SELECT * FROM transcripts WHERE transcript_id = 'ENST00000000001'",
            ),
            (
                "Cross Reference Index",
                "SELECT * FROM gene_cross_references WHERE external_id = 'P04637'",
            ),
        ]
            ...
            try:
                ...
                results.append(
                    ValidationResult(
                        ...
                        details={
                            "execution_plan": explain_text[:500]
    ...
    def _generate_validation_report(self, total_time: float) -> Dict[str, Any]:
        ...
        return {
            ...
            "data_comparisons": [
                asdict(comparison) for comparison in self.comparison_results
            ],
    ...
    def _generate_recommendations(self) -> List[Dict[str, str]]:
        ...
        performance_checks = [
            r for r in self.validation_results if "Performance" in r.check_name
        ]
