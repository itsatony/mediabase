...
@pytest.mark.skip(
    reason="Requires full ETL infrastructure, external APIs (GENCODE, UniProt, PubMed), and separate integration environment. Fixture also has duplicate definition and missing dbname parameter."
)
...
def test_full_etl_pipeline(test_db):
    ...
    transcript_processor = TranscriptProcessor(
        {**test_db, "cache_dir": "/tmp/test_mediabase"}
    )
