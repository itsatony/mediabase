...
class UnifiedProgressBar:
    ...
    def __init__(
        self, total: int, desc: str, module_name: str = "mediabase", unit: str = "it"
    ) -> None:
...
class ProgressManager:
    ...
    def _create_tracked_bar(
        self, bar: UnifiedProgressBar, bar_id: int
    ) -> UnifiedProgressBar:
    ...
    def create_download_bar(
        self, desc: str, total: int, module_name: str
    ) -> UnifiedProgressBar:
...
def get_progress_bar(
    total: int, desc: str, module_name: str = "mediabase", unit: str = "it"
) -> UnifiedProgressBar:
...
def create_download_progress_bar(
    desc: str, total: int, module_name: str
) -> UnifiedProgressBar:
    """Create a properly formatted download progress bar.
...
def setup_logging(
    ...
    if log_file:
        ...
        file_formatter = logging.Formatter(
            DEFAULT_LOG_FORMAT, datefmt=DEFAULT_LOG_DATE_FORMAT
        )
...
def get_logger(
    module_name: str, log_level: Union[int, str] = DEFAULT_LOG_LEVEL
) -> logging.Logger:
