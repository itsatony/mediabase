...
def match_exact(
    symbol: str, targets: Union[List[str], Set[str], Dict[str, Any]]
) -> Optional[str]:
...
def match_genes_bulk(
    query_genes: List[str], target_genes: List[str], use_fuzzy: bool = False
) -> Dict[str, str]:
...
def get_gene_match_stats(
    query_genes: List[str], matched_genes: Dict[str, str]
) -> Dict[str, Any]:
