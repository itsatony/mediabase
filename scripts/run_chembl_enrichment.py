...
def main() -> None:
    ...
    if not db_manager.check_connection():
        console.print("[bold red]Database connection failed. Please check your configuration.[/bold red]")
        sys.exit(1)
    ...
    try:
        ...
        processor.run()
        console.print("[bold green]ChEMBL drug enrichment completed successfully![/bold green]")
