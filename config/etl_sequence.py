...
MODULE_DEPENDENCIES = {
    ...
    "pubtator": [
        "transcript",
        "id_enrichment",
    ],  # Needs transcript and NCBI Gene ID mappings
    "opentargets": [
        "transcript",
        "id_enrichment",
    ],  # Needs transcript and Ensembl Gene ID mappings
    "drugs": [
        "transcript",
        "id_enrichment",
        "go_terms",
    ...
    "evidence_scoring": [
        ...
        "go_terms",
        "publications",
    ],  # Needs all evidence sources
    "pharmgkb_annotations": [
        "transcript",
        "id_enrichment",
    ],  # Needs transcript and ID data
